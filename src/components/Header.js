...
function Header() {
  ...
  const API = [
    ...
    },
    {
      ...
      des: "WebClazify maintains its own crowdsourced warning list, which is continuously expanding. Additionally, you can create your own blacklist. Search our proprietary database of known fraudulent companies.",
    },
    {
      title: "Logo API",
      href: "/api/logo-api",
          ...
          <Col md={5}>
            {currentAPI ? (
              ...
              <Container>
                ...
                <div style={{ marginTop: "150px" }} className="text-white">
                  <div className="bg-white rounded p-2 d-flex justify-content-center align-items-center mt-4 shadow-sm">
                    <input
                      type="text"
                      className="form-control border-0 me-2 w-75"
          ...
          <Col md={7} className=" ">
            ...
            <div className="d-flex   justify-content-center">
              <button
                ...
                className="border-white btn btn-dark z-2 btn-lg rounded h-100 larger-button"
              >
                Get Started Free
              </button>
              <button
                ...
                style={{ backgroundColor: "#8A2BE2", cursor: "pointer" }}
                className="border-white  btn btn-dark btn-lg z-2  rounded h-100 larger-button"
              >
                Book A Demo
              </button>
            </div>
